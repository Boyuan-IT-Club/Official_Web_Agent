...
| 5.1 | 技术文档:架构与模块导览 | 完成 | design.md v0.3:代码导览/两条流程/文档地图;standards 落位表更新到重构后 |
| 5.2 | 设计文档:重构决策 ADR | 完成 | ADR-0009(web 拆分)/0010(state 包+池)/0011(错误类型化)/0012(trace 贯穿) |
| 5.3 | 开发者上手指南 | 完成 | standards/README「上手路径」:clone→闸门→PR 全程 |
